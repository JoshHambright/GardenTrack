...
**Every exit criterion names a device.** GardenTrack has three device tiers with
three different jobs (PRODUCT §6, D-018), and "it works" is not a claim you can
make without saying where you were standing. Phone is the priority tier; the bed
editor is the one deliberate exception, designed at landscape tablet.
